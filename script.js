...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const options = document.getElementById("team-filter");
    ...
    function populateOptions(players){
        // Get teams names
    ...
    let selectTeamElem = document.getElementsByClassName("team-filter")[0];
    selectTeamElem.addEventListener("change", filterByTeam);

    let inputSearchElem = document.getElementById("search")
    inputSearchElem.addEventListener("keyup", filterByPlayer)

    let darkModeBut = document.getElementById("dark-mode-toggle");
    darkModeBut.addEventListener("click", ()=>{
...
function filterByTeam(){
  ...
  let menuItem = document.getElementsByClassName("team-filter")[0]
